...
export default function ProductDialog({
  ...
  useEffect(() => {
    ...
    setLoaded(
      Boolean(
        firstUrl && media[0]?.type === "image" && isImageCached(firstUrl),
      ),
    );
  ...
  useEffect(() => {
    ...
    setLoaded(
      Boolean(url && media[safeIdx]?.type === "image" && isImageCached(url)),
    );
    setPlaying(false);
    setBuffering(false);
    setTransitioning(false);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        style={{
          ...
          background: "#080504",
          boxShadow:
            "0 40px 120px -20px rgba(0,0,0,0.85), 0 0 0 1px rgba(196,144,106,0.18)",
          display: "flex",
      ...
      >
        ...
        <div className="lg:hidden flex flex-col h-full overflow-hidden">
          ...
          >
              ...
              {(!loaded || buffering) && (
                ...
                >
                  <div
                    ...
                    style={{
                      borderColor: "rgba(196,144,106,0.6)",
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to top, rgba(8,5,4,0.6), transparent)",
              }}
            />
                ...
                {media.map((_, i) => (
                  <button
                    ...
                    style={{
                      ...
                      height: 6,
                      background:
                        i === safeIdx ? "#C4906A" : "rgba(255,255,255,0.35)",
                    }}
                  />
                ))}
              </div>
          ...
          {multi && count <= 8 && (
            <div
              ...
              style={{
                background: "#0a0604",
                borderTop: "1px solid rgba(196,144,106,0.12)",
              }}
            >
              <div
                ref={thumbsRef}
          ...
          {/* Info panel */}
          <div
            className="dialog-scroll flex-1 overflow-y-auto min-h-0"
            style={{
              background: "linear-gradient(160deg, #faf7f3 0%, #f5ede3 100%)",
            }}
          >
            <div className="px-5 pt-5 pb-4 space-y-4">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, rgba(196,144,106,0.4), transparent)",
                }}
              />
          ...
          <div
            ...
            style={{
              background: "#faf7f3",
              borderTop: "1px solid rgba(196,144,106,0.18)",
            }}
          >
            <WhatsAppButton
              product={product}
        ...
        >
          ...
          <div
            ...
            style={{ width: "55%", flexShrink: 0, background: "#080504" }}
          >
            ...
            {multi && (
              <div
                ...
                style={{
                  ...
                  scrollbarWidth: "none",
                  background:
                    "linear-gradient(to right, rgba(8,5,4,0.92), rgba(8,5,4,0.5), transparent)",
                      ...
                      <span
                        style={{
                          ...
                          border: active
                            ...
                            : "2px solid transparent",
                          boxShadow: active
                            ? "0 0 12px rgba(196,144,106,0.55)"
                            : "none",
                          pointerEvents: "none",
            ...
            <div className="absolute inset-0" style={{ left: multi ? 72 : 0 }}>
                ...
                {(!loaded || buffering) && (
                  ...
                  >
                    <div
                      ...
                      style={{
                        borderColor: "rgba(196,144,106,0.4)",
                        borderTopColor: "#C4906A",
                      }}
                    />
                  </div>
                )}
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to bottom, rgba(8,5,4,0.45), transparent)",
                }}
              />
              {/* Bottom gradient */}
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to top, rgba(8,5,4,0.65), transparent)",
                }}
              />
                  ...
                  {[
                    ...
                    <button
                      ...
                      style={{
                        ...
                        border: "1px solid rgba(196,144,106,0.38)",
                        backdropFilter: "blur(8px)",
                      }}
                    >
                      {b.icon}
                  ...
                  {media.map((_, i) => (
                    <button
                      ...
                      style={{
                        ...
                        height: 7,
                        background:
                          i === safeIdx ? "#C4906A" : "rgba(255,255,255,0.3)",
                      }}
                    />
                  ))}
                </div>
              ...
              {multi && (
                <div
                  className="absolute top-5 right-5 z-20 px-3 py-1 rounded-full text-[11px] font-semibold text-white/80"
                  style={{
          ...
          <div
            ...
            style={{
              background: "linear-gradient(160deg, #faf8f4 0%, #f3e9dd 100%)",
            }}
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, #9B6844, #D4A96A, #C4906A, transparent)",
              }}
            />
            ...
            <div className="dialog-scroll flex-1 overflow-y-auto">
              <div className="px-8 xl:px-10 pt-8 pb-6 space-y-5">
                  ...
                  <div className="flex gap-0.5">
                    {[...Array(3)].map((_, i) => (
                      <div
                        ...
                        style={{ background: "#C4906A", opacity: 1 - i * 0.25 }}
                      />
                    ))}
                  </div>
                  <span
                ...
                <div>
                  <h1
                    className="text-lg xl:text-xl font-bold leading-tight text-zinc-900"
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(90deg, rgba(196,144,106,0.55), rgba(196,144,106,0.1), transparent)",
                    }}
                  />
                </div>
                  ...
                  {[
                    ...
                    <div
                      ...
                      style={{
                        ...
                        backdropFilter: "blur(8px)",
                        boxShadow: "0 2px 12px rgba(196,144,106,0.08)",
                      }}
                    >
                ...
                {product.description && (
                  <div>
                    ...
                    <div
                      className="text-[13px] xl:text-sm leading-[1.75] text-zinc-600 prose prose-sm max-w-none"
                      dangerouslySetInnerHTML={{ __html: product.description }}
                    />
                  </div>
                )}
            ...
            {/* CTA — pinned bottom */}
            <div
              className="flex-shrink-0 px-8 xl:px-10 py-5"
              style={{
                borderTop: "1px solid rgba(196,144,106,0.2)",
                background: "rgba(250,247,243,0.95)",
                backdropFilter: "blur(12px)",
              }}
            >
              <p
                className="text-[9.5px] text-center tracking-[0.2em] uppercase font-semibold mb-3.5"
                style={{ color: "#A0714A" }}
              >
