      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="py-6 px-8 rounded-xl mb-8"
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 text-center lg:text-left">
            ...
            <div className="flex justify-center">
              <img src={logo} alt="Flenix Jewels" className="h-20 w-auto mx-auto p-1 object-contain"
                loading="lazy" decoding="async" fetchpriority="low" />
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <img src={logo} alt="Flenix Jewels" className="h-20 w-auto"
              loading="lazy" decoding="async" fetchpriority="low" />
            <p className="text-sm text-muted-foreground">
              Discover Exquisite Lab-Grown and Natural Diamond Jewelry. Premium Luxury Collections
              for Every Occasion.
            </p>
          </div>
            ...
            <div className="flex flex-wrap gap-3">
              {contactInfo?.facebook && (
                <a href={contactInfo.facebook} target="_blank" rel="noopener noreferrer"
                  ...
                  style={{ background: 'rgba(196,144,106,0.12)', color: '#C4906A' }}
                  onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.background = 'linear-gradient(135deg,#9B6844,#D4A96A)'; (e.currentTarget as HTMLAnchorElement).style.color = '#fff'; }}
                  onMouseLeave={e => { (e.currentTarget as HTMLAnchorElement).style.background = 'rgba(196,144,106,0.12)'; (e.currentTarget as HTMLAnchorElement).style.color = '#C4906A'; }}
                  aria-label="Facebook">
