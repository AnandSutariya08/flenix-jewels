...
const features = [
  {
    ...
    sub: "15+ Countries",
    detail: "Fully insured express delivery to your door.",
  },
  {
    icon: MessageCircle,
    label: "WhatsApp Support",
    sub: "24/7 Support",
    detail: "Get quick help for orders, custom designs, and diamond inquiries.",
  },
  {
    icon: ShieldCheck,
    label: "Secure Payments",
    sub: "100% Encrypted",
    detail: "Bank-level security on every transaction.",
  },
  {
    icon: Award,
    label: "Certified Authentic",
    sub: "GIA / IGI",
    detail: "Lifetime guarantee on all certified pieces.",
  },
];
      ...
      <main className="flex-1" style={{ paddingTop: `${paddingTop}px` }}>
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-12">
            ...
            <div className="lg:pb-2 max-w-sm">
              <p className="text-muted-foreground leading-relaxed mb-5">
                Each piece is a testament to exceptional artisanship and
                timeless elegance, designed to be cherished forever.
              </p>
              <Link
                to="/categories"
                className="inline-flex items-center gap-2 text-sm font-bold tracking-widest uppercase transition-all group text-primary"
              >
              ...
              {categories.slice(1, 5).map((cat, i) => (
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(to top, rgba(6,3,1,0.78) 0%, transparent 60%)",
                    }}
                  />
        ...
        {featuredCollection.length > 0 && (
          <section
            ...
            style={{ background: isDark ? "#0c0703" : "#f5ede3" }}
          >
            {/* Header + chevrons row */}
            <div className="flex items-end justify-between px-4 md:px-10 lg:px-16 mb-14 max-w-[1600px] mx-auto">
              <div>
                <p
                  className="text-[10px] tracking-[0.32em] uppercase font-black mb-3"
                  style={{ color: "#C4906A" }}
                >
                  ✦ Curated For You
                </p>
              ...
              <div className="flex items-center gap-4">
                <p
                  className="hidden lg:block text-sm max-w-[200px] text-right leading-relaxed"
                  style={{
                    color: isDark
                ...
                <div className="hidden md:flex items-center gap-2">
                  <button
                    ...
                    style={{
                      ...
                      background: isDark
                        ? "rgba(196,144,106,0.08)"
                        : "rgba(196,144,106,0.10)",
                      color: "#C4906A",
                    }}
                  >
            ...
            >
              {featuredCollection.map((item, i) => (
                ...
                >
                  ...
                  {i > 0 && (
                    <div
                      className="absolute left-0 top-12 bottom-12 w-px pointer-events-none"
                      style={{
                        background:
                          "linear-gradient(to bottom, transparent, rgba(196,144,106,0.25) 30%, rgba(196,144,106,0.25) 70%, transparent)",
                      }}
                    />
                  )}
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(to top, rgba(4,2,1,0.92) 0%, rgba(4,2,1,0.4) 35%, transparent 65%)",
                      }}
                    />
                    {/* Hover gold sheen */}
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(135deg, rgba(196,144,106,0.08), transparent 60%)",
                      }}
                    />
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                      <p
                        className="text-[9px] tracking-[0.3em] uppercase font-black mb-2"
                        style={{ color: "#C4906A" }}
                      >
                        Flenix Jewels Ltd
                      </p>
                ...
                {featuredCollection.map((_, i) => (
                  <button
                    ...
                    onClick={() => {
                      ...
                      const cardW = (el.firstElementChild as HTMLElement)
                        .offsetWidth;
        ...
        <section
          ...
          style={{ background: isDark ? "#0c0703" : "#1a0f06" }}
        >
          <div
            className="absolute top-0 left-0 right-0 h-px"
            style={{
              background:
                "linear-gradient(90deg, transparent 5%, #C4906A 35%, #D4A96A 50%, #C4906A 65%, transparent 95%)",
            }}
          />
          {/* Ambient glow */}
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at top right, rgba(196,144,106,0.10) 0%, transparent 65%)",
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at bottom left, rgba(196,144,106,0.08) 0%, transparent 65%)",
              transform: "translate(-30%, 30%)",
            }}
          />
          ...
          <div className="relative z-10 max-w-[1400px] mx-auto px-4 md:px-16 py-24 md:py-36">
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
              ...
              <div>
                <p
                  className="text-[10px] tracking-[0.35em] uppercase font-black mb-7"
                  style={{ color: "#C4906A" }}
                >
                  ✦ Our Story
                </p>
                ...
                >
                  Flenix Jewels Ltd is a premier destination for luxury jewelry
                  — combining traditional artisanship with contemporary design.
                  From ethically sourced diamonds to handcrafted settings, every
                ...
                <div className="flex flex-wrap gap-2.5 mb-12">
                  {[
                    ...
                    <span
                      key={tag}
                      className="text-[10.5px] font-bold tracking-wider uppercase px-4 py-2 rounded-full"
                      style={{
                        border: "1px solid rgba(196,144,106,0.30)",
                        color: "rgba(196,144,106,0.85)",
                      }}
                    >
                      {tag}
                    </span>
                ...
                <Link
                  to="/about"
                  className="inline-flex items-center gap-3 font-bold text-sm tracking-widest uppercase transition-all duration-200 group"
                  style={{ color: "#D4A96A" }}
                >
                  Our Full Story
                  <ArrowRight className="h-4 w-4 transition-transform duration-200 group-hover:translate-x-1.5" />
              ...
              <div className="grid grid-cols-2 gap-4 md:gap-5">
                {[
                  ...
                  <div
                    key={label}
                    className="relative p-7 md:p-8 rounded-2xl overflow-hidden group transition-all duration-300 hover:-translate-y-1"
                    style={{
                      background: "rgba(196,144,106,0.07)",
                      border: "1px solid rgba(196,144,106,0.16)",
                    }}
                  >
                    <div
                    ...
                    />
                    <Icon
                      className="h-5 w-5 mb-5 relative z-10"
                      style={{ color: "rgba(196,144,106,0.5)" }}
                    />
                    <div
                    ...
                    <p
                      className="text-[10.5px] font-bold tracking-[0.18em] uppercase relative z-10"
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent 5%, rgba(196,144,106,0.3) 35%, rgba(212,169,106,0.4) 50%, rgba(196,144,106,0.3) 65%, transparent 95%)",
            }}
          />
        </section>
        ...
        <section className="py-20 md:py-28 px-4 md:px-10 lg:px-16 max-w-[1600px] mx-auto">
          <div className="text-center mb-16">
            <p
              className="text-[10px] tracking-[0.32em] uppercase font-black mb-3.5"
              style={{ color: "#C4906A" }}
            >
              ✦ Why Choose Us
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {features.map(({ icon: Icon, label, sub, detail }) => (
              <div
                key={label}
                className="group relative p-7 md:p-8 rounded-3xl overflow-hidden cursor-default transition-all duration-500 hover:-translate-y-2 bg-card"
                style={{
                  border: "1px solid rgba(196,144,106,0.18)",
                  boxShadow: "0 2px 20px rgba(196,144,106,0.06)",
                }}
              >
                {/* Top gold bar on hover */}
                <div
                  className="absolute top-0 left-6 right-6 h-0.5 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-400"
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(196,144,106,0.05), transparent)",
                ...
                <div className="relative z-10">
                  <div
                    className="w-14 h-14 rounded-2xl flex items-center justify-center mb-7 transition-all duration-300 group-hover:scale-110 group-hover:rotate-3"
                    style={{ background: "rgba(196,144,106,0.10)" }}
                  >
                    <Icon className="h-6 w-6" style={{ color: "#C4906A" }} />
                  </div>
                  <h3 className="font-bold text-[17px] mb-1.5 leading-snug">
                    {label}
                  </h3>
                  <p
        ...
        <section
          ...
          style={{ background: isDark ? "#080400" : "#0e0804" }}
        >
          {/* Ambient glow */}
          <div
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at bottom left, rgba(212,169,106,0.08) 0%, transparent 65%)",
              transform: "translate(-20%,20%)",
            }}
          />
          <div
          ...
          <div className="relative z-10 max-w-[1600px] mx-auto px-4 md:px-10 lg:px-16">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-12">
              <div>
                <p
                  className="text-[10px] tracking-[0.35em] uppercase font-black mb-3"
                  style={{ color: "#C4906A" }}
                >
                  ✦ Gallery
                </p>
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.06] text-white">
                  Moments
                  <br className="hidden md:block" /> in Gold
                </h2>
              </div>
              <div className="lg:pb-2">
                ...
                >
                  Each piece is a testament to exceptional artisanship —
                  photographed to reveal every facet.
                </p>
                <Link
                  to="/gallery"
            ...
            (deferredStatus === "loading" ||
              ...
              >
                <div
                  className="col-span-12 md:col-span-5 row-span-3 rounded-3xl animate-pulse"
                  style={{ background: "rgba(196,144,106,0.12)" }}
                />
                <div
                  className="col-span-12 md:col-span-7 row-span-2 rounded-2xl animate-pulse"
                  style={{
              ...
              <div className="flex items-center justify-center mt-10">
                <Link
                  ...
                  style={{
                    background: GOLD,
                    color: "#fff",
                    boxShadow: "0 8px 30px -6px rgba(155,104,68,0.5)",
                  }}
                >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent 5%, rgba(196,144,106,0.25) 50%, transparent 95%)",
            }}
          />
        </section>
        ...
        {testimonials.length > 0 && (
          <section className="py-20 overflow-hidden bg-secondary/60 dark:bg-secondary/20">
            <div className="text-center mb-14 px-4">
              <p className="text-[10px] tracking-[0.32em] uppercase font-black mb-3.5 text-primary">
                ✦ Client Love ✦
              </p>
              <h2 className="text-4xl md:text-5xl font-bold tracking-tight">
                Testimonial
                ...
                >
                  ...
                  <div className="flex gap-0.5 mb-5">
                    {[...Array(5)].map((_, j) => (
                      <Star
                        key={j}
                        className={`h-4 w-4 ${j < t.rating ? "fill-gold text-gold" : "text-muted-foreground/30"}`}
                      />
                    ))}
                  </div>
                  {/* Large serif quote mark */}
                  <p
                    className="text-6xl leading-none font-serif mb-1 text-primary/25"
                    style={{ fontFamily: "Georgia, serif" }}
                  >
                    "
                  </p>
                  <p className="text-[14.5px] leading-[1.75] mb-7 line-clamp-4 text-foreground/80">
                    {t.text}
                  </p>
        ...
        <section className="py-20 md:py-28 px-4 md:px-10 lg:px-16 max-w-[1400px] mx-auto">
          <div className="flex flex-wrap items-end justify-between gap-4 mb-10 md:mb-14">
            ...
            <Link
              to="/blog"
              className="inline-flex items-center gap-2 text-sm font-bold tracking-widest uppercase group"
              style={{ color: "#C4906A" }}
            >
              All Articles{" "}
              <ArrowRight className="h-4 w-4 transition-transform duration-200 group-hover:translate-x-1.5" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 md:gap-8">
              ...
              {sortedBlogs[0] && (
                <article
                  ...
                  onClick={() => openBlog(sortedBlogs[0])}
                >
                  <div className="relative h-64 md:h-[400px] rounded-3xl overflow-hidden mb-6">
                    <OptimizedImage
                      noWrapper
                      src={sortedBlogs[0].thumbnail || sortedBlogs[0].image}
                    ...
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(to top, rgba(6,3,1,0.55) 0%, transparent 55%)",
                      }}
                    />
                    <span
                      className="absolute top-5 left-5 text-[10px] font-black tracking-[0.2em] uppercase px-3.5 py-1.5 rounded-full"
                      style={{ background: GOLD, color: "#fff" }}
                    >
                      Featured
                    </span>
                  ...
                  <time className="text-[11px] text-muted-foreground tracking-widest uppercase font-semibold">
                    {new Date(sortedBlogs[0].date).toLocaleDateString("en-US", {
                      month: "long",
                      day: "numeric",
                      year: "numeric",
                    })}
        ...
        ═══════════════════════════════════════════════════════ */}
        <section
          className="relative overflow-hidden mx-4 md:mx-10 lg:mx-16 mb-24 rounded-3xl"
          style={{ background: "#0c0703" }}
        >
          {/* Ambient glow */}
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 70% 60% at 50% 50%, rgba(196,144,106,0.18) 0%, transparent 70%)",
            }}
          />
          {/* Gold borders */}
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent 10%, rgba(196,144,106,0.5) 40%, rgba(212,169,106,0.6) 50%, rgba(196,144,106,0.5) 60%, transparent 90%)",
            }}
          />
          <div
            className="absolute bottom-0 left-0 right-0 h-px"
            style={{
              background:
                "linear-gradient(90deg, transparent 10%, rgba(196,144,106,0.3) 40%, rgba(196,144,106,0.3) 60%, transparent 90%)",
            }}
          />
          {/* Decorative corner diamonds */}
          <span
            className="absolute top-8 left-10 text-2xl opacity-20"
            style={{ color: "#C4906A" }}
          >
            ✦
          </span>
          <span
            className="absolute top-8 right-10 text-2xl opacity-20"
            style={{ color: "#C4906A" }}
          >
            ✦
          </span>
          <span
            className="absolute bottom-8 left-10 text-lg opacity-10"
            style={{ color: "#C4906A" }}
          >
            ✦
          </span>
          <span
            className="absolute bottom-8 right-10 text-lg opacity-10"
            style={{ color: "#C4906A" }}
          >
            ✦
          </span>
          ...
          <div className="relative z-10 text-center py-20 md:py-28 px-6">
            <p
              className="text-[10px] tracking-[0.45em] uppercase font-black mb-7"
              style={{ color: "#C4906A" }}
            >
            ...
            <p
              className="mb-12 max-w-lg mx-auto leading-[1.8] text-lg"
              style={{ color: "rgba(255,255,255,0.45)" }}
            >
              Connect with our jewelry experts for a personalized consultation.
              We craft bespoke pieces that tell your unique story.
            </p>
            <a
              href={WHATSAPP}
              target="_blank"
        ...
        {/* ═══════════════════════════════════════════════════════
            WRITE A REVIEW — Just above footer
        ═══════════════════════════════════════════════════════ */}
        <section className="py-16 md:py-24 bg-[#F5EDE3] dark:bg-[#0a0603]">
            ...
            <div className="text-center mb-10">
              <div className="flex items-center justify-center gap-3 mb-4">
                <div
                  className="h-px w-10"
                  style={{
                    background: "linear-gradient(90deg, transparent, #C4906A)",
                  }}
                />
                ...
                <div
                  className="h-px w-10"
                  style={{
                    background: "linear-gradient(90deg, #C4906A, transparent)",
                  }}
                />
              </div>
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-[#1C0D05] dark:text-[#F5E8D8]">
                Write a Review
              </h2>
              <p className="mt-3 text-sm text-[#9B8070] dark:text-[#7A6050]">
                Your experience matters — leave a review and help others
                discover Flenix Jewels.
              </p>
            </div>

            {reviewSubmitted ? (
              <div
                className="flex flex-col items-center justify-center gap-4 py-14 text-center rounded-3xl"
                style={{
                  background: "rgba(196,144,106,0.07)",
              ...
              >
                <div
                  ...
                  style={{
                    background: "linear-gradient(135deg, #9B6844, #C4906A)",
                  }}
                >
                  <CheckCircle className="h-8 w-8 text-white" />
                </div>
                <h3 className="text-xl font-bold text-[#1C0D05] dark:text-[#F5E8D8]">
              ...
              <form
                ...
                className="rounded-3xl p-8 md:p-10 space-y-5 bg-white dark:bg-[#150a04]"
                style={{
                  border: "1px solid rgba(196,144,106,0.18)",
                  boxShadow: "0 8px 48px -12px rgba(0,0,0,0.10)",
                }}
              >
                {/* Star rating */}
                <div className="flex flex-col items-center gap-3 pb-2">
                  <p className="text-[11px] tracking-[0.18em] uppercase font-black text-[#9B8070]">
                    Your Rating *
                  </p>
                  <div className="flex gap-2">
                    {[1, 2, 3, 4, 5].map((s) => (
                      <Star
                        key={s}
                        className={`h-9 w-9 cursor-pointer transition-all duration-150 ${
                          s <= (reviewHoverRating || reviewRating)
                            ? "fill-yellow-400 text-yellow-400 scale-110"
                            : "text-[#D4B896] dark:text-[#5A4030]"
                        }`}
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block text-[11px] tracking-[0.18em] uppercase font-black mb-2 text-[#9B8070] dark:text-[#7A6050]">
                      Your Name *
                    </label>
                    <input
                      type="text"
                      ...
                      required
                      maxLength={100}
                      className="w-full px-4 py-3.5 rounded-xl text-sm font-medium outline-none transition-all duration-200 bg-[#F5EDE3] dark:bg-[#1a0c06] text-[#1C0D05] dark:text-[#F5E8D8] placeholder:text-[#C4A080] border border-transparent focus:border-[#C4906A]"
                    />
                  </div>
                  <div>
                    <label className="block text-[11px] tracking-[0.18em] uppercase font-black mb-2 text-[#9B8070] dark:text-[#7A6050]">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Tell us about your experience with Flenix Jewels…"
                    rows={5}
                    required
                    maxLength={500}
                    className="w-full px-4 py-3.5 rounded-xl text-sm font-medium outline-none transition-all duration-200 bg-[#F5EDE3] dark:bg-[#1a0c06] text-[#1C0D05] dark:text-[#F5E8D8] placeholder:text-[#C4A080] border border-transparent focus:border-[#C4906A] resize-none"
                  />
                  <p className="text-right text-[10px] text-[#C4A080] mt-1">
                ...
                <button
                  type="submit"
                  disabled={
                    reviewSubmitting || !reviewName.trim() || !reviewText.trim()
                  }
                  ...
                  style={{
                    background: GOLD,
                    color: "#fff",
                    boxShadow: "0 8px 28px -8px rgba(155,104,68,0.55)",
                  }}
                >
                  {reviewSubmitting ? (
                    <>
